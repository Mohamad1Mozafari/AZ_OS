# راهنمای کامل دستورات پروژه آزمایشگاه سیستم‌عامل

> نکته: قبل از هر بخش، از ترمینال خودت (بعد از اجرای هر دستور) اسکرین‌شات بگیر و در گزارش کنار توضیح مربوطه قرار بده.
